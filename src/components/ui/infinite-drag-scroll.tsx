    ...
    "overflow-hidden hover:cursor-pointer w-full h-full will-change-transform",
    {
      variants: {
        variant: {
          ...
          luxury: "rounded-[2rem] shadow-2xl even:mt-[30%] odd:mt-[10%] hover:scale-[1.02] transition-transform duration-700",
        },
      },
      defaultVariants: {
        variant: "default",
    ...
    const gridBodyStyles = cva("grid grid-cols-[repeat(6,1fr)] h-fit w-fit", {
      variants: {
        variant: {
          ...
          masonry: "gap-x-14 px-7 md:gap-x-28 md:px-14 gap-y-14 py-7 md:gap-y-28 md:py-14",
          polaroid: "gap-x-14 px-7 md:gap-x-28 md:px-14 gap-y-14 py-7 md:gap-y-28 md:py-14",
          luxury: "gap-x-20 px-10 md:gap-x-40 md:px-20 gap-y-20 py-10 md:gap-y-40 md:py-20",
        },
      },
      defaultVariants: {
        variant: "default",
